...
// Node Deleter
void Del_node( int a, int a_f,int b, int b_f,int Rows, int Columns, Graph<float, int> graph)
{

    vector<Point> Delt;

            Delt.push_back(Point(a,a_f));
            Delt.push_back(Point(b,b_f));
...
int main()
{
    ...
    int x,x_f,y,y_f;
    cout << "Insert Parametro de Inicio: ";
    cin >> x>>x_f;
    cout << "Insert Parametro de Fin: ";
    cin >> y>>y_f;

    Del_node( x,x_f,y,y_f ,Rows,Columns,graph);
